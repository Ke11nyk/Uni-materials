...
/* package faculty-newspaper-1.0.0.0 */
#ifndef VERSION_faculty_newspaper
#define VERSION_faculty_newspaper "1.0.0.0"
#endif /* VERSION_faculty_newspaper */
#ifndef MIN_VERSION_faculty_newspaper
#define MIN_VERSION_faculty_newspaper(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_faculty_newspaper */
...
#define CURRENT_COMPONENT_ID "faculty-newspaper-1.0.0.0-inplace-faculty-newspaper"
